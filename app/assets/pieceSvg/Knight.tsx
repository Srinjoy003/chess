...
export function BlackKnight({ size }: ChessPieceProp) {
	return (
		<svg
			className={size}
		...
		>
			...
			>
				...
				<path
					fill="#ececec"
					stroke="#ececec"
					d="M9.5 25.5a.5.5 0 11-1 0 .5.5 0 111 0zm5.433-9.75a.5 1.5 30 11-.866-.5.5 1.5 30 11.866.5z"
				></path>
				<path
					fill="#ececec"
					stroke="none"
...
export function WhiteKnight({ size }: ChessPieceProp) {
	return (
		<svg
			className={size}
			xmlns="http://www.w3.org/2000/svg"
