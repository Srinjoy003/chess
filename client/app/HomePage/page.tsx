		...
		<div className="w-screen h-screen bg-black flex flex-row items center justify-center">
			<div className="absolute w-full h-full flex flex-col items-center justify-center font-bold gap-10 sm:gap-10 md:gap-12 lg:gap-14 z-10">
				...
				<div className="flex row items-center justify-center gap-8 md:gap-9 lg:gap-10 text-xs md:text-sm lg:text-base">
					<button className="h-11 w-28 md:h-14 md:w-32 md:px-3 md:py-1 lg:h-16 lg:w-40 lg:px-4 lg:py-2 bg-white text-black border border-solid border-black duration-300 ease-in-out hover:bg-opacity-0 hover:text-white hover:border-white rounded">
						Multiplayer
					</button>
					<button className="h-11 w-28 md:h-14 md:w-32 md:px-3 md:py-1 lg:h-16 lg:w-40 lg:px-4 lg:py-2 text-white border-white border border-solid transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-20 rounded">
						Play Computer
					</button>
				</div>
			</div>
